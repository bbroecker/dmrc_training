...
class ExperienceEpisodeBuffer:
    ...
    def add(self, x, y, episode):
        self.extend_episode_buffer(episode)
        self.episode_buffer[episode][0].append(x)
    ...
    def sample(self, batch_size, trace_length):
        ...
        while sample_count < batch_size:
            ...
            for i in range(point, point + trace_length):
                x.append([self.episode_buffer[e][0][i]])
...
class RRNDynamicQueueModel(object):
    ...
    def init_network(self):
        ...
        # self.td_error = tf_mod((self.predict - self.Y) + 0.5, 1.0) - 0.5
