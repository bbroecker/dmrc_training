...
from tf_nn_sim.Environments import PuckNormalRandomFrontend

CONFIG_FILE = "../Config/PuckNormalRandom/puckworld.yaml"


class PuckNormalRandomworld(Environment):
    def __init__(self, show = True):
        ...
        self.goal_count = 0
        if show:
            self.frontend = PuckNormalRandomFrontend(self)
