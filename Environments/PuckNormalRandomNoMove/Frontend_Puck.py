...
class PuckNormalRandomNoMoveFrontend:
    # path update and path_lenght in seconds
    def __init__(self, env):
        assert isinstance(env, Environments.PuckNormalRandomNoMove.Puckworld_Environment.PuckNormalRandomworldNoMove)
        self.env = env
    ...
    def draw(self):
        assert isinstance(self.env, Environments.PuckNormalRandomNoMove.Puckworld_Environment.PuckNormalRandomworldNoMove)
